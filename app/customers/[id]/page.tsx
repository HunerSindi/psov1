...
import PrintCustomerSales from "./components/PrintCustomerSales";
        ...
        <div className="min-h-screen bg-gray-100 font-sans flex flex-col print:bg-white">
            <div className="bg-blue-600 h-13 p-3 flex justify-between items-center sticky top-0 z-30 print:hidden">
                <div className="flex items-center gap-4">
                    <button onClick={() => router.push("/customers")} className="text-white font-bold hover:text-black uppercase text-sm flex items-center gap-1">
