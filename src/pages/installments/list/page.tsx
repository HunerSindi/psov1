    ...
    return (
        <div className="h-screen flex flex-col bg-gray-100 font-sans">
            <div className="bg-white border-b border-gray-400 p-3 flex items-center gap-4 sticky top-0 z-30">
                <button onClick={() => navigate("/")} className="font-bold text-gray-600 uppercase text-xs flex items-center gap-1"><ArrowLeft size={16} /> Back</button>
                                ...
                                data.map((p) => (
                                    <tr key={p.id} className="hover:bg-blue-50 group">
                                        ...
                                        <td className="p-2 text-center">
                                            <button
                                                onClick={() => navigate(`/installments/${p.id}`)}
