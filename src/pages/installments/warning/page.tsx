        ...
        <div className="h-screen flex flex-col bg-gray-100 font-sans">
            ...
            <div className="bg-red-800 border-b border-red-900 p-3 flex justify-between items-center text-white sticky top-0 z-30">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate("/")} className="font-bold hover:text-gray-300 uppercase text-xs flex items-center gap-1">
                                    ...
                                    (data || []).map((item) => (
                                        <tr key={item.id} className="hover:bg-red-50 group">
                                            ...
                                            <td className="p-2 text-center">
                                                <button
                                                    onClick={() => navigate(`/installments/${item.installment_id}`)}
